  ...
  return (
    <>
      <Head>
        ...
        <meta content="정원재❤조소영 결혼식에 초대합니다" name="Title" />
        <meta
          content="2025년 4월 5일 토요일 오후 3시 00분"
          name="Description"
        />
        <meta content="2025년 4월 5일 토요일 오후 3시 00분" name="Keyword" />
        <meta property="og:title" content="정원재❤조소영 결혼식에 초대합니다" />
        <meta
